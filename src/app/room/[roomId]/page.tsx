...
export default function RoomPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a1a] flex flex-col">
      ...
      <button
        onClick={toggleSound}
        className="fixed top-4 right-4 z-40 w-10 h-10 bg-gray-800/80 hover:bg-gray-700 border border-gray-600 rounded-full flex items-center justify-center text-white shadow-lg backdrop-blur-sm transition"
